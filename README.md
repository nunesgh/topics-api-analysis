...
1. `data/AOL-data-treatment.ipynb`:
...
2. `data/Citizen-Lab-Classification-data-treatment.ipynb`:
...
3. `data/AOL-treated-Citizen-Lab-Classification-domain-matching.ipynb`:
...
4. `data/AOL-treated-Google-Topics-Classification-v1-domain-matching.ipynb`:
...
5. `data/AOL-reduced-Citizen-Lab-Classification.ipynb`:
...
6. `data/AOL-reduced-Google-Topics-Classification-v1.ipynb`:
    - Converts the dataset `AOL-treated.csv`.
...
8. `data/AOL-experimental-Citizen-Lab-Classification.ipynb`:
    ...
    - Generates the dataset `AOL-experimental-Citizen-Lab-Classification.csv`.
        ...
        - All privacy and utility results are expected to remain the same with each run of the analyses over this dataset.
9. `data/AOL-experimental-Google-Topics-Classification-v1.ipynb`:
